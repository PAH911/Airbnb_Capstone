...
export default function CommentAddModal({
  open,
  onClose,
  onSuccess,
  onFailed,
  ...
  const { addLoading } = useSelector((state) => state.adminComment);
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Tạo bình luận cho phòng</p>
                    </div>
                  </div>
                  <Button
                    type="text"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end gap-4 pt-6 border-t border-gray-600">
                    ...
                    <Button
                      ...
                      htmlType="submit"
                      loading={addLoading}
                      className="px-8 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 border-0 rounded-xl shadow-lg"
                    >
                      {addLoading ? "Đang thêm..." : "Thêm bình luận"}
                    </Button>
                  </div>
                </form>
              </Dialog.Panel>
