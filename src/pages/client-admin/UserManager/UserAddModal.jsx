...
import { addUser } from "./adminUserSlice";

export default function UserAddModal({ open, onClose, onSuccess, onFailed }) {
  const dispatch = useDispatch();
  const { addLoading } = useSelector((state) => state.userList);
            ...
            >
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {/* Form inputs như đã code ở trên, giữ nguyên */}
                  <div>
                  ...
                  <div>
                    <label className="block mb-2 font-semibold text-[#EAF7FF]">Mật khẩu</label>
                    <input
                      type="password"
                      name="password"
                      value={form.password}
